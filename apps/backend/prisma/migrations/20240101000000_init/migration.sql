...
CREATE TABLE "User" (
    ...
    "avatarColor" TEXT NOT NULL DEFAULT '#f472b6',
...
-- CreateIndex
CREATE UNIQUE INDEX "Shape_boardId_elementId_key" ON "Shape"("boardId", "elementId");
...
-- AddForeignKey
ALTER TABLE "Shape" ADD CONSTRAINT "Shape_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
