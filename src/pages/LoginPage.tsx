      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              className="w-4 h-4 rounded border-gray-300 text-blush-500 focus:ring-blush-500"
            />
            <span className="text-sm text-gray-600">Remember me</span>
          </label>
          <span className="text-sm text-blush-600 font-medium cursor-not-allowed opacity-60">
            Forgot password?
          </span>
        </div>
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link to="/register" className="text-blush-600 hover:text-blush-700 font-medium">
            Sign up
          </Link>
        </p>
      </form>
